...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="data/val/image")
    parser.add_argument("--mask-dir", default="data/val/label")
    parser.add_argument("--output-img-dir", default="data/val/train/images_1024")
    parser.add_argument("--output-mask-dir", default="data/val/train/masks_1024")
