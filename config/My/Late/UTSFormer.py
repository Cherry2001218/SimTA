...
from geoseg.models.Late.UTSFormer import LSTMUNet
...
weights_name = "UTSFormerLate"
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/MYAFTERU4".format(weights_name)
test_weights_name = "UTSFormerLate"
