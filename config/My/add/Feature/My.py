...
from geoseg.models.After.My import LSTMUNet
...
#After 4 输入输出4LSK +CDC +CONV 
#After 4 输入输出4CDC +CONV  
#3 是 2层
#3X 是加了4Final
#3X21C 是4MYE
#MyO是4MYO
weights_name = "MyPCh1"#-V1 Double
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/simta".format(weights_name)
test_weights_name = "MyPCh1"
