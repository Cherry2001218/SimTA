...
from geoseg.models.concat.Feature.SIMVP import LSTMUNet
...
weights_name = "SIMVPFEATURE"
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/SIMVPFEATURE{}".format(weights_name)
test_weights_name = "SIMVPFEATURE"
