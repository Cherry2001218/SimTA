...
from geoseg.models.concat.Feature.UATE import LSTMUNet
...
#After 4 输入输出LSK +CDC +CONV 
#After 4 输入输出CDC +CONV 
weights_name = "UATEConcatData1"
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/UATEConcatData".format(weights_name)
test_weights_name = "UATEConcatData1"
