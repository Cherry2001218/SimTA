...
from geoseg.models.concat.MyOld import LSTMUNet
...
weights_name = "MyDataConcatNew"
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/MyDataConcat".format(weights_name)
test_weights_name = "MyDataConcatNew"
