...
from geoseg.models.concat.unet import LSTMUNet
...
weights_name = "UnetConcatData"
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/UnetConcatData".format(weights_name)
test_weights_name = "UnetConcatData"
