...
from geoseg.models.concat.TFBS import LSTMUNet
...
weights_name = "TFBSConcatData"
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/TFBSConcatData".format(weights_name)
test_weights_name = "TFBSConcatData"
