...
from geoseg.models.VV.UATE import LSTMUNet
...
weights_name = "UATEVV2517"
weights_path = "/data/pth/liangjiaxuan-pth/UATE/{}".format(weights_name)
test_weights_name = "UATEVV2517"
