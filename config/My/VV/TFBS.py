...
from geoseg.models.VV.TFBS import LSTMUNet
...
weights_name = "TFBSVV25"
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/tfbs".format(weights_name)
test_weights_name = "TFBSVV25"
