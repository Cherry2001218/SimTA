...
from geoseg.models.VV.TAU import LSTMUNet
...
weights_name = "tauvv"
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/VV/TAU".format(weights_name)
test_weights_name = "tauvv"
...
val_dataset = LenMyDataset(data_root=filepath, img_dir='ThImage', mask_dir='ThLabel', mode='val',
