...
from geoseg.models.VV.deeplabv3 import LSTMUNet
...
test_dataset = LenMyDataset(data_root=filepath, img_dir='TImage', mask_dir='TrainingLabel', mode='test',
                           mosaic_ratio=0.0, transform=val_aug, img_size=(256, 256))
