...
from geoseg.models.VH.TDUnet import LSTMUNet
...
weights_name = "lastVH3DUNET"
weights_path = "/data1/ljx/modelweight/".format(weights_name)
test_weights_name = "lastVH3DUNET"
log_name = "/data1/ljx/modelweight/".format(weights_name)
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 1
save_last = True
