...
from geoseg.models.VH.ConvLSTM import LSTMUNet
...
weights_name = "ConvLstmVH"
weights_path = "/data/pth/liangjiaxuan-pth/modelweight/{}".format(weights_name)
test_weights_name = "ConvLstmVH"
log_name = '/data/pth/liangjiaxuan-pth/modelweight/{}'.format(weights_name)
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 1
save_last = True
...
val_dataset = LenMyDataset(data_root=filepath, img_dir='VImage', mask_dir='VLabel', mode='val',
