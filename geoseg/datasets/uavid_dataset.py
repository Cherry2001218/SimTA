...
class UAVIDDataset(Dataset):
    def __init__(self, data_root='E:/uavid/val', mode='val', img_dir='images', mask_dir='masks',
                 img_suffix='.png', mask_suffix='.png', transform=val_aug, mosaic_ratio=0.0,
                 img_size=ORIGIN_IMG_SIZE):
        self.data_root = 'E:/uavid/val'
...
class UAVIDDatasetV2(Dataset):
    def __init__(self, data_root='E:/uavid/val', mode='val', img_dir='images_512', mask_dir='masks_512',
                 img_suffix='.png', mask_suffix='.png', transform=val_aug, mosaic_ratio=0.0,
