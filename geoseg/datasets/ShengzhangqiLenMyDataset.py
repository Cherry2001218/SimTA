...
class LenMyDataset(Dataset):
    ...
    def __getitem__(self, index):
        stacked_tensor = torch.empty(6,3, 256, 256)
        ...
        for i in range(6):
            ...
            img = torch.from_numpy(img).permute(2, 0, 1).float()/2
    ...
    def load_img_and_mask(self, index,i=0):
         ...
         #   print(img_ids,img_name, mask_name)
            ...
            return img, mask
    def load_mosaic_img_and_mask(self, index,i=0):
